...
if (isset($_POST['id_evento'])) {
    ...
    $retorno_query  = editEvento($id_evento, $nombre_evento, $dia_inicio, $dia_termino, $hora_inicio, $hora_termino, $direccion, $localidad, $region, $latitud, $longitud, $contenido, $contenido2);
