...
<div class="full-title">
    <div class="container">
        ...
        <h1 class="mt-4 mb-3">Titulo Evento
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <hr>
            <!-- Date/Time -->
            <p>FECHA EVENTO 1, 2018 at 18:00 PM</p>
            <hr>
            <!-- Post Content -->
            ...
            <div class="container">
                <div class="services-bar">
                    <h1 class="my-4">Pymes que asistirán </h1>
                    <!-- Services Section -->
                    <div class="row">
                        <div class="col-lg-4 mb-4">
                            <div class="card h-100">
                                <h4 class="card-header">Nombre pyme</h4>
                                <div class="card-img">
                                    <img class="img-fluid" src="images/services-img-01.jpg" alt="" />
                                </div>
                                <div class="card-body">
                                    <p class="card-text">Contenido... Contenido... Contenido...Contenido... Contenido... Contenido...
